...
pcall(function()
    local prev = sharedEnv.SynthGAG2
    if prev then
...
pcall(function()
    ...
    elseif getrawmetatable and setreadonly then
        ...
        oldNc = mt.__namecall
        setreadonly(mt, false); mt.__namecall = nc(blocker);
        setreadonly(mt, true)
    end
end)
...
if not Net then
    warn("[SynthHub] Networking module not found — wrong game?")
    return
end
...
local Window = Library:CreateWindow({
	Title = "Synth Hub",
	Footer = "Synth Hub | Version 1",
	NotifySide = "Right",
	ShowCustomCursor = true,
})

local Tabs = {
	Farm = Window:AddTab("Farm", "leaf"),
	Boosts = Window:AddTab("Boosts", "zap"),
	Pets = Window:AddTab("Pets", "paw-print"),
	EggsAndCrates = Window:AddTab("Eggs & Crates", "box"),
	Shop = Window:AddTab("Shop", "shopping-cart"),
	Steal = Window:AddTab("Steal", "swords"),
	Misc = Window:AddTab("Misc", "list"),
	Settings = Window:AddTab("UI Settings", "settings"),
}

-- ---- FARM ----
local FarmLeft = Tabs.Farm:AddLeftGroupbox("Status")
FarmLeft:AddLabel("Plot: ...", false, "StatusPlot")
FarmLeft:AddLabel("Sheckles: ...", false, "StatusCash")
FarmLeft:AddLabel("—", false, "StatusStats")

local FarmLeftMaster = Tabs.Farm:AddLeftGroupbox("Auto-Farm")
FarmLeftMaster:AddToggle("AutoFarm", {Text = "Auto-Farm", Default = false, Callback = function(v) S.autoFarm = v end})
FarmLeftMaster:AddToggle("AutoExpand", {Text = "Auto-Expand garden", Default = false, Callback = function(v) S.autoExpand = v end})
FarmLeftMaster:AddToggle("AutoDaily", {Text = "Auto-Daily deals", Default = false, Callback = function(v) S.autoDaily = v end})

local FarmRightBuy = Tabs.Farm:AddRightGroupbox("Buy seeds")
FarmRightBuy:AddDropdown("BuySeedsDrop", {Values = SEED_NAMES, Multi = true, Text = "Seeds to buy", Callback = function(v) pickMulti(v, S.buySeeds) end})
FarmRightBuy:AddToggle("AutoBuy", {Text = "Auto-Buy selected", Default = false, Callback = function(v) S.autoBuy = v end})
FarmRightBuy:AddSlider("BuyInterval", {Text = "Buy interval", Default = 5, Min = 1, Max = 30, Rounding = 0, Callback = function(v) S.buyInterval = v end})
FarmRightBuy:AddSlider("BuyPerTick", {Text = "Max buys / seed / pass", Default = 8, Min = 1, Max = 50, Rounding = 0, Callback = function(v) S.buyPerTick = v end})

local FarmRightPlant = Tabs.Farm:AddRightGroupbox("Plant / Harvest / Sell")
local plantOpts = {"Best owned"}
for _, n in ipairs(SEED_NAMES) do plantOpts[#plantOpts + 1] = n end
FarmRightPlant:AddDropdown("PlantSeedDrop", {Values = plantOpts, Default = 1, Multi = false, Text = "Seed to plant", Searchable = true, Callback = function(v) S.plantSeed = v end})
FarmRightPlant:AddToggle("AutoPlant", {Text = "Auto-Plant", Default = false, Callback = function(v) S.autoPlant = v end})
FarmRightPlant:AddSlider("PlantSpacing", {Text = "Plant spacing", Default = 4, Min = 2, Max = 10, Rounding = 0, Callback = function(v) S.plantSpacing = v end})
FarmRightPlant:AddToggle("AutoHarvest", {Text = "Auto-Harvest ripe fruit", Default = false, Callback = function(v) S.autoHarvest = v end})
FarmRightPlant:AddSlider("HarvestDelay", {Text = "Harvest pace", Default = 0.01, Min = 0, Max = 0.2, Rounding = 2, Callback = function(v) S.harvestDelay = v end})
FarmRightPlant:AddToggle("AutoSell", {Text = "Auto-Sell", Default = false, Callback = function(v) S.autoSell = v end})
FarmRightPlant:AddSlider("SellInterval", {Text = "Sell interval", Default = 15, Min = 3, Max = 120, Rounding = 0, Callback = function(v) S.sellInterval = v end})
FarmRightPlant:AddToggle("AutoPot", {Text = "Auto-Pot grown plants", Default = false, Callback = function(v) S.autoPot = v end})


-- ---- BOOSTS ----
local BoostsLeft = Tabs.Boosts:AddLeftGroupbox("Sprinklers & Water")
BoostsLeft:AddToggle("AutoSprinkler", {Text = "Auto-place Sprinklers", Default = false, Callback = function(v) S.autoSprinkler = v end})
BoostsLeft:AddSlider("SprinklerInterval", {Text = "Sprinkler interval", Default = 30, Min = 10, Max = 120, Rounding = 0, Callback = function(v) S.sprinklerInterval = v end})
BoostsLeft:AddToggle("AutoWater", {Text = "Auto-Watering Can", Default = false, Callback = function(v) S.autoWater = v end})
BoostsLeft:AddSlider("WaterInterval", {Text = "Water interval", Default = 8, Min = 2, Max = 60, Rounding = 0, Callback = function(v) S.waterInterval = v end})

local BoostsRight = Tabs.Boosts:AddRightGroupbox("Skill points")
BoostsRight:AddDropdown("SkillStatsDrop", {Values = {"BaseSpeed", "BaseJump", "ShovelPower", "MaxBackpack"}, Multi = true, Text = "Stats to level", Callback = function(v) pickMulti(v, S.skillStats) end})
BoostsRight:AddToggle("AutoSkill", {Text = "Auto-Spend skill points", Default = false, Callback = function(v) S.autoSkill = v end})


-- ---- PETS ----
local PetsLeft = Tabs.Pets:AddLeftGroupbox("Pets")
PetsLeft:AddToggle("AutoEquipPets", {Text = "Auto-Equip pets", Default = false, Callback = function(v) S.autoEquipPets = v end})
PetsLeft:AddToggle("AutoPetSlot", {Text = "Auto-Buy pet slots", Default = false, Callback = function(v) S.autoPetSlot = v end})
PetsLeft:AddToggle("AutoBuyPets", {Text = "Auto-Buy world pets", Default = false, Callback = function(v) S.autoBuyPets = v end})
PetsLeft:AddSlider("MaxPetPrice", {Text = "Max pet price", Default = 25000, Min = 1000, Max = 1000000, Rounding = 0, Callback = function(v) S.maxPetPrice = v end})
PetsLeft:AddToggle("PetTeleport", {Text = "Teleport to pet", Default = true, Callback = function(v) S.petTeleport = v end})
PetsLeft:AddSlider("PetBuyInterval", {Text = "Pet buy interval", Default = 5, Min = 2, Max = 60, Rounding = 0, Callback = function(v) S.petBuyInterval = v end})

local PetsRight = Tabs.Pets:AddRightGroupbox("Sell pets")
PetsRight:AddDropdown("SellPetsDrop", {Values = ownedPetNames(), Multi = true, Text = "Pets to sell", Callback = function(v) pickMulti(v, S.sellPets) end})
PetsRight:AddToggle("AutoSellPets", {Text = "Auto-Sell selected pets", Default = false, Callback = function(v) S.autoSellPets = v end})


-- ---- EGGS & CRATES ----
local EggsLeft = Tabs.EggsAndCrates:AddLeftGroupbox("Auto-Open")
EggsLeft:AddToggle("AutoEgg", {Text = "Auto-Open Eggs", Default = false, Callback = function(v) S.autoEgg = v end})
EggsLeft:AddToggle("AutoCrate", {Text = "Auto-Open Crates", Default = false, Callback = function(v) S.autoCrate = v end})
EggsLeft:AddToggle("AutoPack", {Text = "Auto-Open Seed Packs", Default = false, Callback = function(v) S.autoPack = v end})
EggsLeft:AddSlider("OpenInterval", {Text = "Open interval", Default = 4, Min = 1, Max = 30, Rounding = 0, Callback = function(v) S.openInterval = v end})

local EggsRight = Tabs.EggsAndCrates:AddRightGroupbox("Info")
EggsRight:AddLabel("Opens everything you own in each\ncategory. Confirm is automatic.", true)


-- ---- SHOP ----
local ShopLeft = Tabs.Shop:AddLeftGroupbox("Gear shop")
ShopLeft:AddDropdown("GearBuyDrop", {Values = GEAR_NAMES, Multi = true, Text = "Gear to buy", Callback = function(v) pickMulti(v, S.gearBuy) end})
ShopLeft:AddToggle("AutoGear", {Text = "Auto-Buy selected gear", Default = false, Callback = function(v) S.autoGear = v end})
ShopLeft:AddSlider("GearInterval", {Text = "Gear buy interval", Default = 10, Min = 2, Max = 60, Rounding = 0, Callback = function(v) S.gearInterval = v end})


-- ---- STEAL ----
local StealLeft = Tabs.Steal:AddLeftGroupbox("Auto-Steal")
StealLeft:AddToggle("AutoSteal", {Text = "Auto-Steal others' ripe fruit", Default = false, Callback = function(v) S.autoSteal = v end})
StealLeft:AddToggle("StealTeleport", {Text = "Teleport to fruit", Default = true, Callback = function(v) S.stealTeleport = v end})
StealLeft:AddToggle("StealReturnBase", {Text = "Return to base after each fruit", Default = true, Callback = function(v) S.stealReturnBase = v end})
StealLeft:AddSlider("StealDelay", {Text = "Steal speed", Default = 0.05, Min = 0, Max = 1, Rounding = 2, Callback = function(v) S.stealDelay = v end})

local StealRight = Tabs.Steal:AddRightGroupbox("Info")
StealRight:AddLabel("Night-only · TP to fruit, steal,\nthen TP home to bank each one.", true)


-- ---- MISC ----
local MiscLeft1 = Tabs.Misc:AddLeftGroupbox("Mail & Gifts")
MiscLeft1:AddToggle("AutoMail", {Text = "Auto-Claim mailbox", Default = false, Callback = function(v) S.autoMail = v end})
MiscLeft1:AddToggle("AutoAcceptGift", {Text = "Auto-Accept gifts", Default = false, Callback = function(v) S.autoAcceptGift = v end})

local MiscLeft2 = Tabs.Misc:AddLeftGroupbox("Session")
MiscLeft2:AddToggle("AntiAfk", {Text = "Anti-AFK", Default = true, Callback = function(v) S.antiAfk = v end})
MiscLeft2:AddToggle("AutoHop", {Text = "Auto server-hop", Default = false, Callback = function(v) S.autoHop = v end})
MiscLeft2:AddSlider("HopInterval", {Text = "Hop every", Default = 0, Min = 0, Max = 120, Rounding = 0, Callback = function(v) S.hopInterval = v * 60 end})

local MiscRight1 = Tabs.Misc:AddRightGroupbox("Codes")
MiscRight1:AddInput("RedeemCodeInput", {
    Default = "",
    Numeric = false,
    Finished = true,
    Text = "Redeem a code",
...
MiscRight1:AddToggle("AutoCodes", {Text = "Auto-redeem code list", Default = false, Callback = function(v) S.autoCodes = v end})


-- ---- SETTINGS (Also misc stuff & UI configs) ----
local PerfGroup = Tabs.Misc:AddRightGroupbox("Performance")
PerfGroup:AddToggle("FpsBoost", {Text = "FPS Boost", Default = false, Callback = function(v) S.fpsBoost = v; applyFpsBoost(v) end})
PerfGroup:AddButton({Text = "Unload hub", Func = function() Library:Unload() end})

local WebhookGroup = Tabs.Misc:AddRightGroupbox("Discord Webhook")
WebhookGroup:AddInput("WebhookURL", {Default = "", Text = "Webhook URL", ClearTextOnFocus = false, Callback = function(t) S.webhookUrl = t or "" end})
WebhookGroup:AddToggle("WebhookEnabled", {Text = "Enable reports", Default = false, Callback = function(v) S.webhookEnabled = v end})
WebhookGroup:AddSlider("WebhookInterval", {Text = "Report interval", Default = 5, Min = 1, Max = 60, Rounding = 0, Callback = function(v) S.webhookInterval = v * 60 end})
WebhookGroup:AddButton({Text = "Send test report", Func = function() task.spawn(function() sendWebhook(true) end) end})
...
task.spawn(function()
    while not S.killed do
        local p = myPlot()
        if Options.StatusPlot then pcall(function() Options.StatusPlot:SetText("Plot: " .. (p and p.Name or "?")) end) end
        if Options.StatusCash then pcall(function() Options.StatusCash:SetText(string.format("Sheckles: %s · Tokens: %s", fmt(getSheckles()), fmt(getTokens()))) end) end
        if Options.StatusStats then pcall(function() Options.StatusStats:SetText(string.format("bought %d · planted %d · harvested %d · sold %d (+%s)", Stats.bought, Stats.planted, Stats.harvested, Stats.sold, fmt(Stats.earned))) end) end
        task.wait(2)
    end
end)

pcall(function()
    if getgenv then getgenv().SynthGAG2 = {
...
SaveManager:SetIgnoreIndexes({ "MenuKeybind" })
ThemeManager:SetFolder("SynthHub")
SaveManager:SetFolder("SynthHub/GrowAGarden2")
SaveManager:BuildConfigSection(Tabs.Settings)
